        ...
        for employee in employees:
            ...
            if employee['regular'] != '퇴사':
                if 'email' in employee and employee['email']:
                    ...
                    email = None            
                if 'mode' not in employee:
                    employee['mode'] = '내근'
                if 'attendMode' not in employee:
                    employee['attendMode'] = 'O'

                employee_info = {'name': employee['name'], 'employeeId': employee['employeeId'], 'email': email, 'regular': employee['regular'], 'mode': employee['mode'], 'attendMode': employee['attendMode']}
