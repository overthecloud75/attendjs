...
import { register, login, password, lostPassword, passwordWithOtp, logout, setAttend, search, getApiKey, updateApiKey, validateToken, authCallback, verify } from '../controllers/auth.js'
