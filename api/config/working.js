export const WORKING = {
    ...
    update: ['상근', '병특'],
    reason: {휴가: 0, 병가: 0, 반차: 4, 외근: 8, 재택: 8, 출근: 8, 기타: 8},
    offDay: {휴가: 1, 병가: 1, 반차: 0.5, 오전반차: 0.5, 오후반차: 0.5, 지각: 0, 미출근: 0},
...
export const MOBILE_IP_LIST = [ '203.226', '211.234', '211.235', '223.33', '223.38', '223.39', '223.62', '39.7', '110.70', '118.235', '175.223', '211.246', '106.101', '106.102', '117.111', '211.36']
...
export const projectVersion = '2.3.2'